...
argparser.add_argument(r'-gpus', r'--gpus', type=str, help=r'GPUs to use', required=False, default='')
...
print(device, torch.cuda.device_count(), torch.cuda.is_available())
