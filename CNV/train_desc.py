...
if __name__=='__main__':
	...
	supervisor = DescrSupervisor(settings)

	supervisor.train_plain(epochs=50)

	# get dataset
	eval = True #False for internal sets
	testset = DescrBinaryDS(csv_file=settings.data.csv_file_test, descr_file=settings.data.descr_file, eval=eval)
